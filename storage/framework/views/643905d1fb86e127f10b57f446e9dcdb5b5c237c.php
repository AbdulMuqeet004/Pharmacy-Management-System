...
<body>
    <div class="mainContainer">
        <h1 style="text-align:center;"> Add Customer Information </h1>
        ...
        <form action="<?php echo e(route ('customer.store')); ?>" method="post">
            ...
            <input type="text" id="cnic" name="cnic" value=""><br><br>
...
</body><?php /**PATH C:\xampp\htdocs\sp19-bcs-044(pharmacy)\resources\views/customer/add.blade.php ENDPATH**/ ?>