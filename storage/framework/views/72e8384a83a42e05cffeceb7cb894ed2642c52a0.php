...
<body>
    <div class="mainContainer">
        <h1 style="text-align:center;"> Add COMPANY Information </h1>
        ...
        <form action="<?php echo e(route ('company.store')); ?>" method="post">
            ...
            <label for="hq">HEADQUATER: &nbsp;</label>
            <input type="text" id="hq" name="hq" value=""><br><br>
...
</body><?php /**PATH C:\xampp\htdocs\sp19-bcs-044(pharmacy)\resources\views/company/add.blade.php ENDPATH**/ ?>