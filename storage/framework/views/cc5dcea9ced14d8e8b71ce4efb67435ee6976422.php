...
<body>
    <div class="mainContainer">
        <h1 style="text-align:center;"> Add sale Information </h1>
        ...
        <form action="<?php echo e(route ('sale.store')); ?>" method="post">
            ...
            <label for="inv">MEDICINE: &nbsp;</label>
            <select id="dropdown" name="inv">
                <?php $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <input type="number" id="quantity" name="quantity" value=""><br><br>
...
</body><?php /**PATH C:\xampp\htdocs\sp19-bcs-044(pharmacy)\resources\views/sale/add.blade.php ENDPATH**/ ?>