    ...
    <div class="mainContainer">
        ...
        <form action="<?php echo e(route ('medicine.store')); ?>" method="post">
            ...
            <select id="dropdown" name="comp">
                <?php $__currentLoopData = $Plane; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Plane): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($Plane->id); ?>">
                    <?php echo e($Plane->name); ?>
...
</body><?php /**PATH C:\xampp\htdocs\sp19-bcs-044(pharmacy)\resources\views/medicine/add.blade.php ENDPATH**/ ?>